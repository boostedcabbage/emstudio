...
#ifndef NITROUSSETTINGSVIEW_H
#define NITROUSSETTINGSVIEW_H

#include <QWidget>
#include "rawdata.h"
#include "dataview.h"
#include "ui_nitroussettingsview.h"

class NitrousSettingsView : public DataView
{
	Q_OBJECT
	
public:
	explicit NitrousSettingsView(bool isram, bool isflash,QWidget *parent = 0);
	~NitrousSettingsView();
