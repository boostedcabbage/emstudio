...
#ifndef CUTANDLIMITERSETTINGSVIEW_H
#define CUTANDLIMITERSETTINGSVIEW_H

#include <QWidget>
#include "rawdata.h"
#include "dataview.h"
#include "ui_cutandlimitersettingsview.h"

class CutAndLimiterSettingsView : public DataView
{
	Q_OBJECT
	
public:
	explicit CutAndLimiterSettingsView(bool isram, bool isflash,QWidget *parent = 0);
	~CutAndLimiterSettingsView();
...
private:
	bool m_isRam;
	Ui::CutAndLimiterSettingsView ui;
